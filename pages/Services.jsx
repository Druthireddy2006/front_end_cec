...
const Services = () => (
  <section className="services-section">
    ...
    <div className="video-container">
      <iframe width="1296" height="729" src="https://www.youtube.com/embed/pygAs1zZptg" title="Food Delivery Animation video | After Effects |" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowhalfcreen></iframe>
    </div>
